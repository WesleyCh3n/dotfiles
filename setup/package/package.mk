...
ifeq ($(UNAME_S),Darwin)
	...
	LINK_NVIM := https://github.com/neovim/neovim/releases/download/v0.9.0/nvim-macos.tar.gz
	...
	LINK_NVIM := https://github.com/neovim/neovim/releases/download/v0.9.0/nvim-linux64.tar.gz
