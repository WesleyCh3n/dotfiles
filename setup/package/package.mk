...
ifeq ($(UNAME_S),Darwin)
	...
	LINK_NVIM := https://github.com/neovim/neovim/releases/download/nightly/nvim-macos.tar.gz
	...
	LINK_NNN := https://github.com/jarun/nnn/releases/download/v4.4/nnn-nerd-static-4.4.x86_64.tar.gz
	LINK_NVIM := https://github.com/neovim/neovim/releases/download/nightly/nvim-linux64.tar.gz
